...
def main():
    ...
    parser.add_argument(
        ...
        "--out",
        default=None,
        help="Caminho do arquivo de saída (default: mesmo nome do PDF com extensăo do formato)",
    )
    ...
    if not args.pdf:
        ...
        if not args.pdf:
            raise SystemExit("PDF năo informado.")
    

    pdf_path = Path(args.pdf).expanduser()
    if not pdf_path.exists():
        raise SystemExit(f"Arquivo năo encontrado: {pdf_path}")
